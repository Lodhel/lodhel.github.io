...
Персональный сайт на Vue 3 и Vite, опубликованный на GitHub Pages по основному адресу [r-tatarinov.ru](https://r-tatarinov.ru/).
...
1. Добавить URL-prefix ресурс `https://r-tatarinov.ru/` в [Google Search Console](https://search.google.com/search-console/).
...
3. В разделе **Sitemaps** отправить `https://r-tatarinov.ru/sitemap.xml`.
4. Открыть **URL Inspection** для `https://r-tatarinov.ru/`, запустить live-проверку и нажать **Request Indexing**.
...
1. Добавить `https://r-tatarinov.ru/` в [Яндекс Вебмастер](https://webmaster.yandex.ru/) и подтвердить права. Для meta-тега или HTML-файла потребуется новый deployment.
2. Добавить `https://r-tatarinov.ru/sitemap.xml` в разделе **Индексирование → Файлы Sitemap**.
3. Проверить `robots.txt`, sitemap и главную страницу в инструментах диагностики Вебмастера.
4. Отправить `https://r-tatarinov.ru/` на переобход через **Индексирование → Переобход страниц**.
